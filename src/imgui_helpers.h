...
static GLFWwindow* Initialize(float* out_scale) 
{
    ...
    if (out_scale) *out_scale = main_scale;
...
// Handles background clearing and Vulkan draw submissions
static void RenderFrame(ImDrawData* draw_data, const ImVec4& clear_color) 
{
